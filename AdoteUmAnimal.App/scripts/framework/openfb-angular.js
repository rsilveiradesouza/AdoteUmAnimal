...
var openFB = (function () {
    ...
    function login(callback, options) {
        ...
        var url_fb = loginURL + '?client_id=' + fbAppId + '&redirect_uri=' + redirectURL + '&response_type=token&scope=' + scope;

        loginWindow = window.open(url_fb, '_blank', 'location=no,clearcache=yes');
    ...
    function api(obj, fields) {
        ...
        url = 'https://graph.facebook.com' + obj.path + (fields ? '' : '?') + toQueryString(params);
    ...
    function info(success, error) {
        return api({
            method: 'GET',
            path: '/me?fields=id,email,first_name,last_name,picture&',
