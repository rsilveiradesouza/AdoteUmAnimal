...
namespace AdoteUmCao.Aplicacao.DTOs
{
    public class UsuarioDTO
    {
        ...
        public UsuarioDTO(Usuario usuario)
        {
            ...
            {
                this.UsuarioAnimaisPreferencias = new List<UsuarioAnimalPreferenciaDTO>();

                for (int i = 0; i < usuario.UsuarioAnimaisPreferencias.Count; i++)
                {
                    UsuarioAnimalPreferenciaDTO uap = new UsuarioAnimalPreferenciaDTO();
                    ...
                    if (usuario.UsuarioAnimaisPreferencias[i].Animal != null)
                    {
                        ...
                        uap.Animal.CorId = usuario.UsuarioAnimaisPreferencias[i].Animal.CorId.HasValue ? (int)usuario.UsuarioAnimaisPreferencias[i].Animal.CorId : 0;
                        uap.Animal.TipoAnimalId = usuario.UsuarioAnimaisPreferencias[i].Animal.TipoAnimalId;
                        uap.Animal.Idade = usuario.UsuarioAnimaisPreferencias[i].Animal.Idade.HasValue ? (int)usuario.UsuarioAnimaisPreferencias[i].Animal.Idade : 0;
                        ...
                        if (usuario.UsuarioAnimaisPreferencias[i].Animal.TipoAnimal != null)
                        {
                            ...
                            {
                                uap.Animal.TipoAnimal.Tipo = new TipoDTO();
                            ...
                            {
                                uap.Animal.TipoAnimal.Raca = new RacaDTO();
        ...
        public List<UsuarioAnimalPreferenciaDTO> UsuarioAnimaisPreferencias { get; set; }
