...
{
    public class UsuarioAnimalPreferencia
    {
        public UsuarioAnimalPreferencia()
        {

        }

        public UsuarioAnimalPreferencia(UsuarioAnimalPreferencia usuariosAnimaisPreferencias)
        {
